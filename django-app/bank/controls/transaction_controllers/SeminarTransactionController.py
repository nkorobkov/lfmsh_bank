...
class SeminarTransactionController(TableTransactionController):
  ...
  def _get_mark_keys():
    return [
        'content_quality', 'knowledge_quality', 'presentation_quality',
        'presentation_quality_2', 'presentation_quality_3', 'unusual_things',
        'materials', 'discussion', 'general_quality'
    ]
